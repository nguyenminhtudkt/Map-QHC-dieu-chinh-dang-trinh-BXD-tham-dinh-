...
var style_Diadiem_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("ten") !== null) {
        ...
        function rules_Diadiem_14(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_Diadiem_14rule0_eval_expression(context)) {
        ...
        var style = rules_Diadiem_14(feature, value);
        ;
