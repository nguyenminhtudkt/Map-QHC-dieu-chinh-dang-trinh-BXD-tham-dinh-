...
lyr_GoogleRoad_0.setVisible(false);lyr_SQG_1.setVisible(true);lyr_STC_2.setVisible(true);lyr_QHCdieuchinhHLGTCC_3.setVisible(true);lyr_QHCdieuchinhDepot_4.setVisible(true);lyr_QHCdieuchinhTuyen_5.setVisible(true);lyr_PhngX_6.setVisible(false);lyr_QunHuyn_7.setVisible(true);lyr_Tnh_8.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_SQG_1,lyr_STC_2,lyr_QHCdieuchinhHLGTCC_3,lyr_QHCdieuchinhDepot_4,lyr_QHCdieuchinhTuyen_5,lyr_PhngX_6,lyr_QunHuyn_7,lyr_Tnh_8];
...
lyr_QHCdieuchinhDepot_4.set('fieldAliases', {'fid': 'fid', });
...
lyr_QHCdieuchinhDepot_4.set('fieldImages', {'fid': 'TextEdit', });
...
lyr_QHCdieuchinhHLGTCC_3.set('fieldLabels', {'fid': 'hidden field', 'loaiduong': 'inline label - visible with data', });
lyr_QHCdieuchinhDepot_4.set('fieldLabels', {'fid': 'no label', });
lyr_QHCdieuchinhTuyen_5.set('fieldLabels', {'fid': 'hidden field', 'tuyen': 'inline label - visible with data', 'doantuyen': 'hidden field', 'huongtuyen': 'inline label - visible with data', 'caongam': 'hidden field', });
...
lyr_QunHuyn_7.set('fieldLabels', {'GID_2': 'no label', 'GID_0': 'no label', 'COUNTRY': 'no label', 'GID_1': 'no label', 'NAME_1': 'no label', 'NL_NAME_1': 'no label', 'NAME_2': 'inline label - visible with data', 'VARNAME_2': 'no label', 'NL_NAME_2': 'no label', 'TYPE_2': 'no label', 'ENGTYPE_2': 'no label', 'CC_2': 'no label', 'HASC_2': 'no label', });
